...
async def inference(
    ...
    query_inputs_arr = (
        [param.strip() for param in fields.split(",")] if query_types else []
    )
    query_types_arr = (
        [param.strip() for param in query_types.split(",")] if query_types else []
    )
    keywords_arr = (
